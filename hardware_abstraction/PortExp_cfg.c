        ...
        const uint16_t u16Size )
{
    ...
    return ( HAL_OK == HAL_I2C_Master_Transmit( &hi2c1,
                             stPortExpDesc[u32PortExpId].stAddr.u16WrAddr,
                             pu8Data,
                             u16Size,
                             100) );
}
        ...
        const uint16_t u16Size )
{
    ...
    return ( HAL_OK == HAL_I2C_Master_Receive( &hi2c1,
                            stPortExpDesc[u32PortExpId].stAddr.u16RrAddr,
                            pu8Data,
                            u16Size,
                            100) );
}
